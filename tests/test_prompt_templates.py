...
EXPECTED_VARIABLES: dict[tuple[str, str | None], list[str]] = {
    ...
    ("researcher", None): ["task_description", "target_column", "task_type", "data_modality", "baseline_score", "notes_context"],
    ("retriever", None): ["task_description", "target_column", "M", "research_context", "notes_context"],
    ("init", None): ["task_description", "target_column", "model_name", "example_code", "research_context", "notes_context"],
    ("merger", None): ["base_code", "reference_code"],
    ("ablation", None): ["solution_script", "previous_ablations", "notes_context"],
    ("summarize", None): ["ablation_code", "raw_result", "notes_context"],
    ("extractor", None): [
        "solution_script",
        "ablation_summary",
